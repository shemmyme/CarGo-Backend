...
urlpatterns = [
    ...
    path('reviews_user/list/<int:user_id>/', views.UserReview.as_view(), name='review-list'),
    path('reviews/<int:booking_id>/', views.ReviewByBooking.as_view, name='get_review_by_booking_id'),
